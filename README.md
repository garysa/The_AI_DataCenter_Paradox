...
Trillions of dollars are being poured into AI data center infrastructure. But can these facilities
generate a meaningful return on investment before one or more of the following happens?
...
3. **Community/regulatory revolt** — $64B in projects already blocked or delayed due to energy,
   water, and grid impact concerns.
...
Hyperscalers (AWS, Azure, Google Cloud) are generating real cloud revenue and can cross-subsidise
AI infrastructure costs through existing profitable businesses. They will likely survive the paradox.

Pure-play AI infrastructure companies (CoreWeave, Inflection, etc.) face existential risk — their
hardware depreciates faster than their debt matures, and they depend on a narrow customer base.

AI software companies (OpenAI, Anthropic) are burning cash at ~70% of revenue and won't reach
break-even until 2027–2030 at the earliest — well after much of today's H100 infrastructure
becomes a second-tier commodity.

The communities bearing the cost (electricity price increases of up to 833%, water shortages,
grid instability) are increasingly saying no — and their objections are legally and politically valid.
